...
from resources.analytics.analystics_default import  AnalyticsDefault
from resources.analytics.note_accounts import AccountsNote
from resources.analytics.none_accounts import AccountsNone

analytics_api = {
    '/vertical': AnalyticsVerticalResource,
    '/vertical/run': AnalyticsVerticalLogsResource,
    '/vertical/default' : AnalyticsDefault,
    ...
    '/vertical/accounts_filtered/none': AccountsNone,
    '/vertical/accounts_filtered/note': AccountsNote,
