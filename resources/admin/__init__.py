...
from resources.admin.vertical_keyword_group_by_id import (
    AdminVerticalKeywordGroupByIdResource,
)
...
from resources.admin.exclude_account import AdminExcludeAccountResource
...
admin_api = {
    ...
    "/favourite_account/<string:username>": AdminFavouriteAccountResource,
    ...
    "/exclude_account/<string:username>": AdminExcludeAccountResource,
}
